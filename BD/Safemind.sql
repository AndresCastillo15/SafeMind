...
--
-- Servidor: localhost
-- Tiempo de generación: 21-09-2026 a las 23:59:13
...
(3, 'Nicolas', 'Cabrera', 'Cns@asdasd.com', '1234565', '11-1', 7402841152, 'activo', '2026-08-31 15:37:04'),
(4, 'Andres Felipe', 'Castillo Neira', 'acastillo@gmail.com', NULL, NULL, 1234567890, 'Activo', '2026-09-08 06:38:22');
...
INSERT INTO `profesor` (`id_profesor`, `nombre`, `apellido`, `correo`, `password`, `telefono`, `estado`) VALUES
(1, 'Nestor', 'Paez', 'npaez@gmail.com', '12345678', '777', 'Activo');
...
ALTER TABLE `seguimiento`
  ...
  ADD CONSTRAINT `fk_seg_psico` FOREIGN KEY (`id_psicologo`) REFERENCES `profesor` (`id_profesor`);
COMMIT;
